...
--   day254 <- D25.hardLarge
  defaultMain $ testGroup "Advent of Code Tests"
    ...
    -- , testCase "Day 6-4" $ day64 @?= 1252
    -- , testCase "Day 7-1" $ day71 @?= Just 0
    -- , testCase "Day 7-2" $ day72 @?= 1226
    -- , testCase "Day 7-3" $ day73 @?= 5
    -- , testCase "Day 7-4" $ day74 @?= 1252
    -- , testCase "Day 8-1" $ day81 @?= Just 0
    -- , testCase "Day 8-2" $ day82 @?= 1226
    -- , testCase "Day 8-3" $ day83 @?= 5
    -- , testCase "Day 8-4" $ day84 @?= 1252
    -- , testCase "Day 9-1" $ day91 @?= Just 0
    -- , testCase "Day 9-2" $ day92 @?= 1226
    -- , testCase "Day 9-3" $ day93 @?= 5
    -- , testCase "Day 9-4" $ day94 @?= 1252
    -- , testCase "Day 10-1" $ day101 @?= Just 0
    -- , testCase "Day 10-2" $ day102 @?= 1226
    -- , testCase "Day 10-3" $ day103 @?= 5
    -- , testCase "Day 10-4" $ day104 @?= 1252
    -- , testCase "Day 11-1" $ day111 @?= Just 0
    -- , testCase "Day 11-2" $ day112 @?= 1226
    -- , testCase "Day 11-3" $ day113 @?= 5
    -- , testCase "Day 11-4" $ day114 @?= 1252
    -- , testCase "Day 12-1" $ day121 @?= Just 0
    -- , testCase "Day 12-2" $ day122 @?= 1226
    -- , testCase "Day 12-3" $ day123 @?= 5
    -- , testCase "Day 12-4" $ day124 @?= 1252
    -- , testCase "Day 13-1" $ day131 @?= Just 0
    -- , testCase "Day 13-2" $ day132 @?= 1226
    -- , testCase "Day 13-3" $ day133 @?= 5
    -- , testCase "Day 13-4" $ day134 @?= 1252
    -- , testCase "Day 14-1" $ day141 @?= Just 0
    -- , testCase "Day 14-2" $ day142 @?= 1226
    -- , testCase "Day 14-3" $ day143 @?= 5
    -- , testCase "Day 14-4" $ day144 @?= 1252
    -- , testCase "Day 15-1" $ day151 @?= Just 0
    -- , testCase "Day 15-2" $ day152 @?= 1226
    -- , testCase "Day 15-3" $ day153 @?= 5
    -- , testCase "Day 15-4" $ day154 @?= 1252
    -- , testCase "Day 16-1" $ day161 @?= Just 0
    -- , testCase "Day 16-2" $ day162 @?= 1226
    -- , testCase "Day 16-3" $ day163 @?= 5
    -- , testCase "Day 16-4" $ day164 @?= 1252
    -- , testCase "Day 17-1" $ day171 @?= Just 0
    -- , testCase "Day 17-2" $ day172 @?= 1226
    -- , testCase "Day 17-3" $ day173 @?= 5
    -- , testCase "Day 17-4" $ day174 @?= 1252
    -- , testCase "Day 18-1" $ day181 @?= Just 0
    -- , testCase "Day 18-2" $ day182 @?= 1226
    -- , testCase "Day 18-3" $ day183 @?= 5
    -- , testCase "Day 18-4" $ day184 @?= 1252
    -- , testCase "Day 19-1" $ day191 @?= Just 0
    -- , testCase "Day 19-2" $ day192 @?= 1226
    -- , testCase "Day 19-3" $ day193 @?= 5
    -- , testCase "Day 19-4" $ day194 @?= 1252
    -- , testCase "Day 20-1" $ day201 @?= Just 0
    -- , testCase "Day 20-2" $ day202 @?= 1226
    -- , testCase "Day 20-3" $ day203 @?= 5
    -- , testCase "Day 20-4" $ day204 @?= 1252
    -- , testCase "Day 21-1" $ day211 @?= Just 0
    -- , testCase "Day 21-2" $ day212 @?= 1226
    -- , testCase "Day 21-3" $ day213 @?= 5
    -- , testCase "Day 21-4" $ day214 @?= 1252
    -- , testCase "Day 22-1" $ day221 @?= Just 0
    -- , testCase "Day 22-2" $ day222 @?= 1226
    -- , testCase "Day 22-3" $ day223 @?= 5
    -- , testCase "Day 22-4" $ day224 @?= 1252
    -- , testCase "Day 23-1" $ day231 @?= Just 0
    -- , testCase "Day 23-2" $ day232 @?= 1226
    -- , testCase "Day 23-3" $ day233 @?= 5
    -- , testCase "Day 23-4" $ day234 @?= 1252
    -- , testCase "Day 24-1" $ day241 @?= Just 0
    -- , testCase "Day 24-2" $ day242 @?= 1226
    -- , testCase "Day 24-3" $ day243 @?= 5
    -- , testCase "Day 24-4" $ day244 @?= 1252
    -- , testCase "Day 25-1" $ day251 @?= Just 0
    -- , testCase "Day 25-2" $ day252 @?= 1226
    -- , testCase "Day 25-3" $ day253 @?= 5
    -- , testCase "Day 25-4" $ day254 @?= 1252
    ]
